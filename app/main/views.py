...
def index():
    ...
    return render_template('home.html', title = title, pitch = pitch, pickuplines=pickuplines, interviewpitch= interviewpitch, motivationpitch = motivationpitch, upvotes=upvotes)
